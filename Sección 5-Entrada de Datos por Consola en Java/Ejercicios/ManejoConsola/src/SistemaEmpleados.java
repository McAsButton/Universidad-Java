...
public class SistemaEmpleados {
    public static void main(String[] args) {
        ...
        System.out.println("\tSalario: $%.2f".formatted(salarioEmpleado)); // Formatear el salario (redudante)
        System.out.printf("\tSalario: $%.2f%n", salarioEmpleado); // Otra forma de imprimir el salario formateado
        System.out.println("\tJefe de departamento: " + esJefeDepartamento);
